...
public class JSPUtils {
	...
	public static void editUser(HttpServletRequest request){
		...
		DatabaseManager.get().getUserDatabase().updateField("last_seen", "email", user.getEmail(), Utils.formatDatabaseDate(user.getLastSeen()));
	}
	...
	public static boolean logoutUser(HttpServletRequest request, HttpServletResponse response) throws IOException {
		if(request.getParameter("logout") != null) {
			...
			DatabaseManager.get().getUserDatabase().updateField("last_seen", "email", curUser.getEmail(), Utils.formatDatabaseDate(curUser.getLastSeen()));
	...
	public static void clearPoll(HttpServletRequest request) {
		if(request.getParameter("clearPoll") != null && isCurrentUserAdmin(request.getSession()))
