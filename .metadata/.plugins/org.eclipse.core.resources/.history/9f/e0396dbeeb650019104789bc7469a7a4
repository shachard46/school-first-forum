  ...
  <body>
    <div class="s_r_root">
      ...
      <div class="s_r_container">
        <form name="register" action="dbRegister.jsp" onsubmit="return checkAll();" method="post">
          <label> שם משתמש</label> <input type="text" name="username" placeholder="הכנס שם משתמש" />
          <label>סיסמה</label>
          <input type="password" name="password" placeholder="הכנס סיסמה" />
          <label> אשר סיסמה</label>
          <input type="password" name="password_confirm" placeholder="אשר סיסמה" />
          <label>כתובת דואר</label>
          <input type="email" name="email" placeholder="הכנס כתובת דואר" />
          <label>אשר כתובת דואר</label>
          <input type="email" name="email_confirm" placeholder="הכנס כתובת דואר" />
          ...
          <input type="text" name="teamNumber" placeholder="הכנס מספר קבוצה" /> <label>מדינה</label>
          <select name="country">
            ...
            <option value="איחוד האמירויות הערביות">איחוד האמירויות הערביות</option>
            <option value="איטליה">איטליה</option>
            <option value="איי הבהאמה">איי הבהאמה</option>
            <option value="איי הבתולה (האמריקניים)">איי הבתולה (האמריקניים)</option>
            ...
            <option value="איראן (הרפובליקה האיסלאמית של)">איראן (הרפובליקה האיסלאמית של)</option>
            ...
            <option value="הרפובליקה המרכז אפריקאית">הרפובליקה המרכז אפריקאית</option>
            ...
            <option value="סין, הרפובליקה העממית של">סין, הרפובליקה העממית של</option>
          ...
          <input type="date" name="rookieTime" placeholder="הכנס תאריך הצטרפות לקבוצה" />
