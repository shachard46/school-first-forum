	...
	<div class="s_r_root">
		...
		<div class="s_r_container">
			<form name="register" action="dbRegister.jsp"
				...
				<label> שם משתמש</label> <input type="text" name="username"
				...
				</select> <label>מספר קבוצה</label> <input type="text" name="teamNumber"
					placeholder="הכנס מספר קבוצה" /> <label>מדינה</label> <select
					name="country">
					...
					<option value="איחוד האמירויות הערביות">איחוד האמירויות
						הערביות</option>
					<option value="איטליה">איטליה</option>
					<option value="איי הבהאמה">איי הבהאמה</option>
					<option value="איי הבתולה (האמריקניים)">איי הבתולה
						(האמריקניים)</option>
					<option value="איי הבתולה (הבריטיים)">איי הבתולה
						(הבריטיים)</option>
					...
					<option value="איראן (הרפובליקה האיסלאמית של)">איראן
						(הרפובליקה האיסלאמית של)</option>
					...
					<option value="ארצות הברית של אמריקה">ארצות הברית של
						אמריקה</option>
					...
					<option value="הרפובליקה הדומיניקנית">הרפובליקה
						הדומיניקנית</option>
					<option value="הרפובליקה המרכז אפריקאית">הרפובליקה המרכז
						אפריקאית</option>
					...
					<option value="מולדובה, הרפובליקה של">מולדובה, הרפובליקה
						של</option>
					...
					<option value="מקדוניה, הרפובליקה של">מקדוניה, הרפובליקה
						של</option>
					...
					<option value="סין, הרפובליקה העממית של">סין, הרפובליקה
						העממית של</option>
					...
					<option value="סנט וינסנט והגרנדינים">סנט וינסנט
						והגרנדינים</option>
				...
				</select> <label>תפקיד בקבוצה</label> <input type="text" name="teamJob"
					placeholder="הכנס תפקיד בקבוצה" /> <label>תאריך הצטרפות
					לקבוצה</label> <input type="date" name="rookieTime"
					placeholder="הכנס תאריך הצטרפות לקבוצה" /> <input type="reset"
					value="נקה" class="button clear-button" /> <input type="submit"
					value="היכנס" class="button send-button" />
			</form>
		</div>
	</div>
</body>
